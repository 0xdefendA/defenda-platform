        ...
        <aside className="w-[240px] flex-shrink-0 border-r border-thin border-border-color bg-surface flex flex-col h-full z-10 hidden md:flex">
            ...
            <div className="flex flex-col py-4 px-2 space-y-1">
                <a className="flex items-center gap-3 px-3 py-2 text-sm font-medium bg-row-hover text-text-main border-l-2 border-primary" href="#">
                    ...
                    All Alerts
                    <span className="ml-auto font-mono text-xs text-muted">142</span>
                </a>
            ...
            <div className="mt-4 px-5 flex flex-col gap-4 flex-grow overflow-y-auto">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="flex items-center gap-2 text-sm text-muted cursor-pointer hover:text-text-main group">
                            <div className="w-4 h-4 border border-border-color flex items-center justify-center group-hover:border-primary transition-colors">
                                <span className="material-symbols-outlined text-[14px] text-primary opacity-0">check</span>
                            </div>
                            Critical
                            <span className="ml-auto font-mono text-[10px]">24</span>
                        </label>
                        <label className="flex items-center gap-2 text-sm text-muted cursor-pointer hover:text-text-main group">
                            <div className="w-4 h-4 border border-border-color flex items-center justify-center group-hover:border-primary transition-colors">
                                <span className="material-symbols-outlined text-[14px] text-primary opacity-0">check</span>
                            ...
                            High
                            <span className="ml-auto font-mono text-[10px]">58</span>
                        </label>
                        <label className="flex items-center gap-2 text-sm text-muted cursor-pointer hover:text-text-main group">
                            <div className="w-4 h-4 border border-border-color flex items-center justify-center group-hover:border-primary transition-colors bg-primary border-primary">
                                <span className="material-symbols-outlined text-[14px] text-white opacity-100">check</span>
                            </div>
                            Medium
                            <span className="ml-auto font-mono text-[10px]">42</span>
                        </label>
                        <label className="flex items-center gap-2 text-sm text-muted cursor-pointer hover:text-text-main group">
                            <div className="w-4 h-4 border border-border-color flex items-center justify-center group-hover:border-primary transition-colors">
                                <span className="material-symbols-outlined text-[14px] text-primary opacity-0">check</span>
                            ...
                            Low
                            <span className="ml-auto font-mono text-[10px]">18</span>
                        </label>
                    </div>
                </div>
