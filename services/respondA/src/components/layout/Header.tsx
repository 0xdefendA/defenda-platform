    ...
    return (
        <header className="h-[48px] bg-surface border-b border-thin border-border-color flex items-center justify-between px-6 flex-shrink-0 z-10 w-full sticky top-0">
            ...
            <div className="flex items-center gap-3">
                ...
                <button className="w-8 h-8 flex items-center justify-center border border-border-color text-muted hover:text-text-main hover:border-text-main transition-colors ml-2">
