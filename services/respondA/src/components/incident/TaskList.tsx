import { CheckCircle2, Circle, Plus, ListTodo, ClipboardCheck } from 'lucide-react';
...
export const TaskList = ({ title, type, tasks, onAdd, onToggle }: TaskListProps) => {
    ...
    return (
        <div className="h-full flex flex-col space-y-4">
            ...
            <div className="flex-1 overflow-auto space-y-2 pr-2">
              ...
              ${type === 'done' ? 'bg-muted/5 opacity-60' : 'bg-surface hover:border-primary/50 cursor-pointer'}`}
                    >
                        {type === 'todo' ? (
